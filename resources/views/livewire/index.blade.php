        ...
        <div class="bg-green-900 text-center py-4 lg:px-4 sm:rounded-lg mb-3">
            <a href="">
                <div class="p-2 bg-green-800 items-center text-green-100 leading-none lg:rounded-full flex lg:inline-flex" role="alert">
                    <span class="flex rounded-full bg-green-500 uppercase px-2 py-1 text-xs font-bold mr-3">Calories Tracker</span>
                    <span class="font-semibold mr-2 text-left flex-auto hover:underline">You can consume {{number_format(2000, 0, ',', '.')}} more calories today</span>
